...
OPTION(objecter_inflight_op_bytes, OPT_U64, 2048*1024*4*1024) // max in-flight data (both directions)
OPTION(objecter_inflight_ops, OPT_U64, 2048)               // max in-flight ios
...
OPTION(osd_client_message_size_cap, OPT_U64, 4000*1024L*1024L) // client data allowed in-memory (in bytes)
OPTION(osd_client_message_cap, OPT_U64, 2000)              // num client messages allowed in-memory
...
OPTION(osd_op_num_threads_per_shard, OPT_INT, 10)
OPTION(osd_op_num_shards, OPT_INT, 1)
